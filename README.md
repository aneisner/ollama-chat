...
* ** Interaktiver Sicherheits-Check:** Bevor ein von der KI generierter Befehl ausgeführt wird, fängt das System (sowohl in der Web-UI als auch im Terminal) diesen ab und verlangt eine manuelle Freigabe. Kein unbefugter Blindflug auf dem Server!
